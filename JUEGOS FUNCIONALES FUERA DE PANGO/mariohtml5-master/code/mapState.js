...
Mario.MapState.prototype.Draw = function(context) {
    ...
    this.Font.Strings[0] = { String: "PANGO " + Mario.MarioCharacter.Lives, X: 4, Y: 4 };
    this.FontShadow.Strings[0] = { String: "PANGO " + Mario.MarioCharacter.Lives, X: 5, Y: 5 };
    this.Font.Strings[1] = { String: "MUNDO " + (this.WorldNumber + 1), X: 256, Y: 4 };
    this.FontShadow.Strings[1] = { String: "MUNDO " + (this.WorldNumber + 1), X: 257, Y: 5 };
