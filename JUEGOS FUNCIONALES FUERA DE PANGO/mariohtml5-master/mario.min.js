...
Mario.WinState.prototype.Enter=function(){this.drawManager=new Enjine.DrawableManager;this.camera=new Enjine.Camera;this.font=Mario.SpriteCuts.CreateBlackFont();this.font.Strings[0]={String:"Gracias por salvarme, Pango!",X:36,Y:160};this.kissing=new Enjine.AnimatedSprite;this.kissing.Image=Enjine.Resources.Images.endScene;this.kissing.X=112;this.kissing.Y=52;this.kissing.SetColumnCount(2);this.kissing.SetRowCount(1);this.kissing.AddNewSequence("loop",0,0,0,1);this.kissing.PlaySequence("loop",!0);
...
-2)this.HelpSprite.X=b*16+16,this.HelpSprite.Y=c*16-16,this.HelpSprite.Draw(a,this.camera);Mario.MarioCharacter.Large?this.LargeMario.Draw(a,this.camera):this.SmallMario.Draw(a,this.camera);this.Font.Strings[0]={String:"PANGOLIN "+Mario.MarioCharacter.Lives,X:4,Y:4};this.FontShadow.Strings[0]={String:"PANGOLIN "+Mario.MarioCharacter.Lives,X:5,Y:5};this.Font.Strings[1]={String:"WORLD "+(this.WorldNumber+1),X:256,Y:4};this.FontShadow.Strings[1]={String:"WORLD "+(this.WorldNumber+1),X:257,Y:5};this.FontShadow.Draw(a,
